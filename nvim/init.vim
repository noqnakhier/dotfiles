...
" for python
" Install coc-pyright
autocmd FileType python nmap <leader>pl :CocCommand python.runLinting<cr>
autocmd FileType python nmap <leader>psi :CocCommand python.sortImports<cr>
autocmd FileType python nmap <leader>gy :CocCommand python.orgnanizeimports<cr>
